...
for s = 1, screen.count() do
    ...
    -- Custom: Add widget to your layout
...
globalkeys = awful.util.table.join(
    ...
    -- Custom
    awful.key({ }, "Print", function () awful.util.spawn("scrot -q 100 -e 'mv $f ~/ 2>/dev/null'") end),
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     -- Custom: remove the small gaps between windows
